...
class EchartSpeed extends Component {
  constructor(props) {
    super(props);
    this.state = {
      echart: null, // echart
  ...
  loadEchart() {
    ...
    var myChart = echarts.init(document.getElementById("speed-main"));
    this.setState({
      echart: myChart
    });
  ...
  componentWillReceiveProps() {
    ...
    if (this.props.data) {
      ...
      this.state.ylabelData.push(this.props.data["sys1_s9"]);
    }
  ...
  render() {
    return <div id="speed-main" className="echart" />;
  }
}

export default EchartSpeed;
